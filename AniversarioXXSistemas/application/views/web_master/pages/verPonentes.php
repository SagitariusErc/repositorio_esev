...
<div class="Aform-style"  style="width: 580px;">
    <form style="margin-left: 5px; margin-right: 5px">
        <legend>
            <span class="title-left">Nuestras:</span> <span
                class="title-form">Ponencias </span>
        </legend>

        <div class="box">
            <div class="box-header" data-original-title="">
                <h2><i class="icon-user"></i><span class="break"></span>Ponentes</h2>                    
            </div>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody role="alert">
                            ...
                            foreach ($ponentes as $row) {
                                ?>
                                <tr class="odd" id="<?php echo $row['idPon']; ?>" title="Ponencia">
